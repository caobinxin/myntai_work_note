...
@(izhoujinjian)
 [高清原文](https://link.jianshu.com?t=https://pan.baidu.com/s/1dFeoPs1#list/path=%2F%E5%8D%9A%E5%AE%A2%E6%80%BB%E7%BB%93%E8%B5%84%E6%BA%90)
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-22b1f76f792bd482.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/630)
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-8aa0635a5646fbc1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/890)

1504662215960.png



![img](https:////upload-images.jianshu.io/upload_images/1309991-7ba8f1a827325c26.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)

2017-09-06 095840.png



![img](https:////upload-images.jianshu.io/upload_images/1309991-df4e62966055ccd9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)

20170306010504849.png
...
Boot Loader：这是启动Android系统之前的引导程序，主要是检查RAM，初始化硬件设备（如CPU、内存、Flash等）并且通过建立内存空间映射，为装载Linux内核准备合适的环境。一旦Linux内核装载完毕，Bootloader将会从内存中清除掉。
 如果用户在Bootloader运行期间，按下预定义的组合健，可以进入系统的更新模块。Android的下载更新可以选择进入Fastboot模式或者Recovery模式。

Fastboot是Android设计的一套通过USB来更新手机分区映像的协议，方便开发人员能快速更新指定的手机分区。但是一般的零售机上往往去掉了Fastboot，Google销售的开发机则带有Fastboot模块。
 Recovery模式是Android特有的升级系统。利用Recovery模式，手机可以进行恢复出厂设置或进行OTA、补丁和固件升级。进入Recovery模式实际上是启动了一个文本模式的Linux。
...
init进程启动Media Server(多媒体服务)、servicemanager(binder服务管家)、bootanim(开机动画)等重要服务
 init进程还会孵化出installd、ueventd、adbd、等用户守护进程；
 init进程孵化出Zygote进程，Zygote进程是Android系统的首个Java进程，Zygote是所有Java进程的父进程，Zygote进程本身是由init进程孵化而来的。
 [Android 7.0 init.rc的一点改变 - 哈哈的个人专栏 - CSDN博客](https://link.jianshu.com?t=http://blog.csdn.net/sunao2002002/article/details/52454878)
...
SystemServer加载完所有的Java服务后，最后会调用ActivityManagerService的SystemReady()方法，在这个方法的执行中，会发出Intent“android.intent.category.HOME”。凡是响应这个Intent的APK都会运行起来，Launcher应用就是Android系统默认的桌面应用，一般只有它会响应这个Intent，因此，系统开机后，第一个运行的应用就是Launcher。
...
前文生成/dev目录后，init进程将调用open_devnull_stdio函数，屏蔽标准的输入输出。
 open_devnull_stdio函数会在/dev目录下生成**null**设备节点文件，并将标准输入、标准输出、标准错误输出全部重定向到**null**设备中。
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-45d9deffee7d5e34.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/839)

20160807170210926.jpg
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-09bc3f944e6dcd47.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)

20160807172447044.jpg
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-01364b8be430b95d.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/471)
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-4eac2b03b03216f3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/674)

1495186216639_37.png
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-76b44aca91ea81dd.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/850)
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-6c72f1b494f8843e.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/845)
...
>
>
> ![img](https:////upload-images.jianshu.io/upload_images/1309991-6e1cc256c0c86cc0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)
>
> 25164254-eadc0c7979b74628aefad305b4b4f75a.png
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-e42dde3d61bfa660.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)

system_server.jpg

图前4步骤（即颜色为紫色的流程）运行在是Zygote进程，从第5步（即颜色为蓝色的流程）ZygoteInit.handleSystemServerProcess开始是运行在新创建的system_server，这是fork机制实现的（fork会返回2次）。下面从startSystemServer()开始讲解详细启动流程。
...
virtual void onZygoteInit()
 ...
 ProcessState::self()是单例模式，主要工作是调用open()打开/dev/binder驱动设备，再利用mmap()映射内核的地址空间，将Binder驱动的fd赋值ProcessState对象中的变量mDriverFD，用于交互操作。startThreadPool()是创建一个新的binder线程，不断进行talkWithDriver()，在binder系列文章中的[注册服务(addService)](https://link.jianshu.com?t=http://gityuan.com/2015/11/14/binder-add-service/)详细这两个方法的执行原理。
...
[理解Application创建过程](https://link.jianshu.com?t=http://gityuan.com/2017/04/02/android-application/)已介绍过createSystemContext()过程， 该过程会创建对象有ActivityThread，Instrumentation, ContextImpl，LoadedApk，Application。
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-f7c961439bb4b650.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/964)
...
> JobSchedulerService NotificationManagerService BackupManagerService
>  AppWidgetService GestureLauncherService DreamManagerService
>  TrustManagerService VoiceInteractionManagerService
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-f1ad06dbb9caa77c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)

25154945-40c8b0ec63774e02af485973a4c05c45.png
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-eecaf0219b426c87.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/973)

20161107165725175.jpg

system_server进程中AMS服务的启动过程，以startBootstrapServices()方法为起点，紧跟着startCoreServices(), startOtherServices()共3个方法。
...
4.5.5.2 installSystemApplicationInfo()
 [-> LoadedApk.java]
...
![img](https:////upload-images.jianshu.io/upload_images/1309991-3b0df9975b8b077c.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000)

20161115174329632.jpg
...
这里暂时先不深究Home Activity启动的具体过程。
 ...
 ActivityStackSupervisor中的activityIdleInternalLocked函数将被调用：
...
[Android 7.0 ActivityManagerService 1 - 10 ](https://link.jianshu.com?t=http://blog.csdn.net/Gaugamela/article/category/6383486)
 [Android Init进程源码分析(1) - jay_richard](https://link.jianshu.com?t=http://blog.leanote.com/post/jay_richard/Android-Init%E8%BF%9B%E7%A8%8B%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90)
 [Android Init进程源码分析(2) - jay_richard](https://link.jianshu.com?t=http://blog.leanote.com/post/jay_richard/Android-Init%E8%BF%9B%E7%A8%8B%E4%B9%8B%E8%A7%A3%E6%9E%90init.rc)
 [Android Zygote进程分析 - jay_richard](https://link.jianshu.com?t=http://blog.leanote.com/post/jay_richard/Android-Zygote%E8%BF%9B%E7%A8%8B%E5%88%86%E6%9E%90)
 [Android Init进程源码分析 - 深入剖析Android系统 - CSDN博客](https://link.jianshu.com?t=http://blog.csdn.net/yangwen123/article/details/9029959)
 [图解Android - Zygote, System Server 启动分析 - 漫天尘沙 - 博客园](https://link.jianshu.com?t=http://www.cnblogs.com/samchen2009/p/3294713.html)
 [Android7.0 init进程源码分析 - ZhangJian的博客 - CSDN博客](https://link.jianshu.com?t=http://blog.csdn.net/gaugamela/article/details/52133186)
 [Android系统启动-Init篇 - Gityuan博客 | 袁辉辉博客](https://link.jianshu.com?t=http://gityuan.com/2016/02/05/android-init/)
 [Android系统启动-zygote篇 - Gityuan博客 | 袁辉辉博客](https://link.jianshu.com?t=http://gityuan.com/2016/02/13/android-zygote/)
 [Android系统启动-SystemServer上篇 - Gityuan博客 | 袁辉辉博客](https://link.jianshu.com?t=http://gityuan.com/2016/02/20/android-system-server/)
 [Android系统启动-SystemServer下篇 - Gityuan博客 | 袁辉辉博客](https://link.jianshu.com?t=http://gityuan.com/2016/02/20/android-system-server-2/)
 [ActivityManagerService启动过程 - Gityuan博客 | 袁辉辉博客](https://link.jianshu.com?t=http://gityuan.com/2016/02/21/activity-manager-service/)

作者：izhoujinjian

链接：https://www.jianshu.com/p/641d0a984362
