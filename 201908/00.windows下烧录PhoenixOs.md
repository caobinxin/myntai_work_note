# 00.windows下烧录PhoenixOs

## 1. 拷贝img

```powershell
# 拷贝镜像
copy \\192.168.1.112\user\cbx\phoenix-n\*  C:\PhoenixOS\

# 拷贝镜像到　efi 分区，此时必须打开　Powershell
...
思路，将拷贝脚本的内容，放在重启脚本的最开始的位置，就可以了
