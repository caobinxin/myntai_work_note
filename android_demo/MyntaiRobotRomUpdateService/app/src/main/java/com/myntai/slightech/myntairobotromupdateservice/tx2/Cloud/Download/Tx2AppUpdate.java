...
public class Tx2AppUpdate implements Parcelable {
    ...
    protected Tx2AppUpdate(Parcel in) {
    ...
    public static final Parcelable.Creator<Tx2AppUpdate> CREATOR = new Parcelable.Creator<Tx2AppUpdate>() {
        @Override
        public Tx2AppUpdate createFromParcel(Parcel source) {
            return new Tx2AppUpdate(source);
        }

        @Override
        public Tx2AppUpdate[] newArray(int size) {
            return new Tx2AppUpdate[size];
        }
    };
}
