...
import com.myntai.slightech.myntairobotromupdateservice.common.network.ISign;
import com.myntai.slightech.myntairobotromupdateservice.common.network.MarvinCloudConfig;
import com.myntai.slightech.myntairobotromupdateservice.common.network.Md5Sign;
...
import static com.myntai.slightech.myntairobotromupdateservice.MainActivity.TAG;

public class PostData {

    private long systemVersion ;
    private String service = "firmware";
    ...
    public void setMapBasic(){
        mapBasic.put("app_id", MarvinCloudConfig.getInstance().getAppId());
        mapBasic.put("timestamp", System.currentTimeMillis() / 1000);
    }

    public long getSystemVersion() {
        systemVersion = Common.getFireflyVersionCode();
    ...
    protected void buildFormData(MultipartBody.Builder builder,
        ...
        //Process data first
        //Add basic data from MarvinCloudConfig.
        dataMap.putAll(MarvinCloudConfig.getInstance().getBasicData());
        //Add into JSON
        ...
        Log.i(TAG, "buildFormData: " + requestParams.toString());
    }
